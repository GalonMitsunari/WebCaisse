...
import webcaisse.DAO.photoDAO;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import javax.swing.table.TableModel;
import webcaisse.model.Utilisateur;
import webcaisse.DAO.UtilisateurDAO;
...
public class UtilCrud extends javax.swing.JFrame {
    ...
    public UtilCrud(Utilisateur utilisateur) {
        this.utConnect = utilisateur;
        initComponents();
        tbUtilisateur.setDefaultRenderer(Object.class, new webcaisse.technic.CTableRendu());
    ...
    private void initComponents() {
        ...
        Entete.setText("Gestion des utilisateurs");
        ...
        uiAdr2.setBackground(new java.awt.Color(255,255,255,120));
        uiAdr2.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        uiAdr2.setForeground(new java.awt.Color(255, 255, 255));

        jLabelMP1.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabelMP1.setForeground(new java.awt.Color(252, 220, 49));
        jLabelMP1.setText("Code postal");
        ...
        uiCommune.setBackground(new java.awt.Color(255,255,255,120));
        uiCommune.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        uiCommune.setForeground(new java.awt.Color(255, 255, 255));

        ChercheVille.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ChercheVille.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ressources/list_20.png"))); // NOI18N
        ChercheVille.setText("Ville");
        ChercheVille.setToolTipText("Choisir la ville de l'utilisateur");
                ...
                .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanelSaisieLayout.createSequentialGroup()
                                    .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(uiNom, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(uiPrenom, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(uiPseudo, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(uiMail, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanelSaisieLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(uiCdpost, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanelSaisieLayout.createSequentialGroup()
                            .addGap(103, 103, 103)
                            .addComponent(uiAdr2, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanelSaisieLayout.createSequentialGroup()
                            .addComponent(ChercheVille)
                            .addGap(12, 12, 12)
                            .addComponent(uiCommune, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanelSaisieLayout.createSequentialGroup()
                            .addComponent(jLabelMail1, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(29, 29, 29)
                            .addComponent(uiAdr1, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanelSaisieLayout.setVerticalGroup(
            ...
            .addGroup(jPanelSaisieLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(uiAdr2, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(uiCdpost, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelMP1, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelSaisieLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(uiCommune, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ChercheVille))
        ...
        message.setBounds(20, 560, 990, 20);
        ...
        Mailer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ressources/envelope_20.png"))); // NOI18N
        Mailer.setText("Mail");
        ...
        AuSujet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ressources/info-circle_20.png"))); // NOI18N
    ...
    private void ChercheVilleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ChercheVilleMouseClicked
        // TODO add your handling code here:
        String codePostal = uiCdpost.getText().strip();
        if (codePostal.matches("[0-9]+") && codePostal.length() == 5) {

            SelectVille selVille = new SelectVille(new javax.swing.JFrame(), true, codePostal, uiNumpost);
            ...
            alert("Saisir le code postal (5 chiffres) avant de selectionner la ville.");
            return;
        }
